import Tab from "../components/Tab/TabProfile";
 ...
 const{handleLogout}=useLogout();
  ...
  return (
    <section className="flex">
      <div className="text-red-200 h-[87vh] bg-black  w-[254px] shadow-lg flex flex-col items-center gap-4 border-t-custom-gym">
