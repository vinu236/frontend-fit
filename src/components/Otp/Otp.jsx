...
const Otp = () => {
  ...
  return (
    <div className="w-full h-screen otp grid place-items-center relative">
      <form onSubmit={handleSubmit}>
        <h1 className="text-white mb-10 text-center text-2xl tracking-wider">Otp</h1>
        ...
        <button className="bg-custom-gym hover:bg-custom-head px-3 py-2 rounded-md flex items-center justify-center text-xl  text-white active:scale-90 tracking-widest" >
      ...
      <h3 className="absolute text-black   font-semi-bold tracking-widest  bottom-10 left-10 text-3xl">Sweat</h3>
    </div>
  );
};
export default Otp;
